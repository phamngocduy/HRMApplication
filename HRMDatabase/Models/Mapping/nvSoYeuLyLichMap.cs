    ...
    public class nvSoYeuLyLichMap : EntityTypeConfiguration<nvSoYeuLyLich>
    {
        public nvSoYeuLyLichMap()
        {
            ...
            this.HasOptional(t => t.QueQuan)
				...
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmDanhHieuPhongTang)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.DanhHieuCaoNhat_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmDanToc)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.DanToc_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmGiaDinhChinhSach)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.GiaDinhChinhSach_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmGioiTinh)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.GioiTinh_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmHangThuongBinh)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.LaThuongBinhHang_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.NoiSinhdmPhuongXa)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.NoiSinh_PhuongXa_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.QueQuandmPhuongXa)
                .WithMany(t => t.nvSoYeuLyLiches1)
                .HasForeignKey(d => d.QueQuan_PhuongXa_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmQuanHamQuanDoi)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.QuanHamCaoNhat_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.NoiSinhdmQuanHuyen)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.NoiSinh_QuanHuyen_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.QueQuandmQuanHuyen)
                .WithMany(t => t.nvSoYeuLyLiches1)
                .HasForeignKey(d => d.QueQuan_QuanHuyen_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.QuocTich)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.QuocTich_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.NoiSinhdmTinhThanh)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.NoiSinh_TinhThanh_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.QueQuandmTinhThanh)
                .WithMany(t => t.nvSoYeuLyLiches1)
                .HasForeignKey(d => d.QueQuan_TinhThanh_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmTonGiao)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.TonGiao_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmTrinhDoChinhTri)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.LyLuanChinhTri_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmTrinhDoHocVan)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.TrinhDoHocVan_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmTrinhDoNgoaiNgu)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.TrinhDoNgoaiNgu_id)
				.WillCascadeOnDelete(false);
            this.HasOptional(t => t.dmTrinhDoTinHoc)
                .WithMany(t => t.nvSoYeuLyLiches)
                .HasForeignKey(d => d.TrinhDoTinHoc_id)
				.WillCascadeOnDelete(false);

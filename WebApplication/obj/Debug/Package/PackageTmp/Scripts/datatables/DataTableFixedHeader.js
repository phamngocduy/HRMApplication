...
FixedHeader.prototype = {
	...
	_fnScrollFixedHeader: function ( oCache )
	{
        ...
        if (oMes.iTableTop > oWin.iScrollTop + s.oOffset.top)
            $(oCache.nWrapper).hide();
        else $(oCache.nWrapper).show();
	...
	_fnCloneThead: function ( oCache )
	{
		...
		jQuery("thead>tr th", s.nTable).each( function (i) {
			jQuery("thead>tr th:eq("+i+")", nTable).width( chrome ? $(this).outerWidth() : $(this).width() );
		} );
		
		jQuery("thead>tr td", s.nTable).each( function (i) {
			jQuery("thead>tr td:eq("+i+")", nTable).width( chrome ? $(this).outerWidth() : $(this).width() );
		} );
	},

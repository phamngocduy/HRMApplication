...
namespace HRM.Databases_HDLaoDong.Models.Mapping
{
    public class hdChiTietHDLDMap : EntityTypeConfiguration<hdChiTietHDLD>
    {
        public hdChiTietHDLDMap()
        {
            ...
            this.Property(t => t.LoaiHD_id).HasColumnName("LoaiHD_id");
            ...
            this.Property(t => t.mauHopDong).HasColumnName("mauHopDong");
            this.Property(t => t.banHopDong).HasColumnName("banHopDong");

            // Relationships
            this.HasRequired(t => t.dmLoaiHopDong)
                .WithMany(t => t.hdChiTietHDLDs)
                .HasForeignKey(d => d.LoaiHD_id)

...
namespace HRM.Databases_HDLaoDong.Models
{
    public partial class HRMDB2Entities : DbContext
    {
        ...
        public DbSet<dmLoaiHopDong> dmLoaiHopDong { get; set; }
        public DbSet<dmMauHopDong> dmMauHopDong { get; set; }
        ...
        {
            modelBuilder.Configurations.Add(new dmLoaiHopDongMap());
            modelBuilder.Configurations.Add(new dmMauHopDongMap());

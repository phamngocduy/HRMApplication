...
{
    public partial class BHXH_2_TangMucDong : System.Web.UI.Page
    {
        ...
        public void reportload()
        {
            ...
            rptDoc.Load(Server.MapPath("~/Forms/HRM1/crystal/BHXH_2_TangMucDong.rpt"));
            rptDoc.LoadConnectionString(); // Fix bug
            //rptDoc.SetDatabaseLogon("sa", "123456");
            TangMucDong2.ReportSource = rptDoc;

...
{
    public partial class BHXH_9_ThayDoiKhac : System.Web.UI.Page
    {
        ...
        public void reportload()
        {
            ...
            rptDoc.Load(Server.MapPath("~/Forms/HRM1/crystal/BHXH_2_ThayDoiKhac.rpt"));
            rptDoc.LoadConnectionString(); // Fix bug
            //rptDoc.SetDatabaseLogon("sa", "123456");
            ThayDoiKhac9.ReportSource = rptDoc;

...
namespace HRM.Webpages.Forms.HRM1
{
    public partial class BHXH_4_TangBHTN : System.Web.UI.Page
    {
        ...
        public void reportload()
        {
            ...
            rptDoc.Load(Server.MapPath("~/Forms/HRM1/crystal/BHXH_4_TangBHTN.rpt"));
            rptDoc.LoadConnectionString(); // Fix bug
            //rptDoc.SetDatabaseLogon("sa", "123456");
            TangBHTN4.ReportSource = rptDoc;

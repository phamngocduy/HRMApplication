...
{
    public partial class BHXH_5_GiamLD : System.Web.UI.Page
    {
        ...
        public void reportload()
        {
            ...
            rptDoc.Load(Server.MapPath("~/Forms/HRM1/crystal/BHXH_5_GiamLD.rpt"));
            rptDoc.LoadConnectionString(); // Fix bug
            //rptDoc.SetDatabaseLogon("sa", "123456");
            GiamLD5.ReportSource = rptDoc;

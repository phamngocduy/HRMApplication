        ...
        */
        "_fnConstruct": function () {
		  ...
		  this.s.dt.oLoadedState.ColReorder.length == this.s.dt.aoColumns.length) {
                ...
                aiSizer = this.s.dt.oLoadedState.ColResizer;
            }
                    ...
                    this.s.dt.aoDrawCallback.push({
                        "fn": function () {
                            if (!that.s.dt._bInitComplete && !bDone) {
                                ...
                                that._fnOrderColumns.call(that, resort, aiSizer);
                            }
                        },
        ...
        */
        "_fnOrderColumns": function (a) {
            ...
            for (var i = 0; i < b.length; i++)
                if (b[i]) {
                    this.s.dt.aoColumns[i].sWidth = b[i];
                    $(this.s.dt.aoColumns[i].nTh).width(b[i]);
                }
        ...
        */
        "_fnStateSave": function (oState) {
            ...
            for (i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                ...
                oState.ColResizer.push(oSettings.aoColumns[i].sWidth);
            }
        },
